...
const formSearchbutton = document.querySelector("#searchForm Button"),
    ...
    selectColor = document.querySelector("#colorFilter");
...
async function image() {
    try {
        ...
        const url = `https://api.unsplash.com/search/photos?page=${page}&query=${keyword}&client_id=${accessKey}&per_page=12${colorParam}`;
